...
class Screenmaindoctor extends StatefulWidget {
  const Screenmaindoctor({Key? key}) : super(key: key);

  @override
  State<Screenmaindoctor> createState() => _ScreenmainState();
}

class _ScreenmainState extends State<Screenmaindoctor> {
  int selectButton = 1;
