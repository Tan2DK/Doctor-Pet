...
import 'package:doctor_pet/core/data/invoice.dart'; // Đảm bảo rằng bạn có đường dẫn đúng đến tệp Medicine
...
class InvoiceView extends GetView<DoctorInvoiceController> {
  ...
  Widget _card() {
    final controller = Get.find<DoctorInvoiceController>(); // Lấy controller
    return Container(
          ...
          Obx(() {
            return Column(
              children:
                ...
                final medicine = selectedMedicine['medicine'] as Invoice;
